                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            <a href="/" class="nav-item nav-link" id="/">Home</a>
                            <a href="/about" class="nav-item nav-link" id="/about">About</a>
                            <a href="/service" class="nav-item nav-link" id="/service">Services</a>
                            <a href="/project" class="nav-item nav-link" id="/project">Projects</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu rounded">
                                    <a href="/blog" class="dropdown-item" id="/blog">Our Blog</a>
                                    <a href="/team" class="dropdown-item" id="/team">Our Team</a>
                                    <a href="/testimonial" class="dropdown-item" id="/testimonial">Testimonial</a>
                                </div>
                            </div>
